({
    ...
    helperPopulateReport :function (component,event,helper, filterDate) {
        ...
        var action = component.get("c.retreivePreAuthsReport");
        ...
        action.setCallback(this,function(res){
            ...
            if(results.length > 0 ){
            component.set('v.preAuthDetails', res.getReturnValue());
                
            }else{
                component.set('v.preAuthDetails', null);
    ...
    helperExpandServiceLine : function(component,event,helper){
        ...
        var lineName = tar.dataset.linename;
        var lineNumber = tar.dataset.linenumber;
        //console.log('lineNumber' + lineNumber);
        //console.log('linename' + lineName);
        $(".moreSection_" + lineNumber+lineName).toggleClass("slds-hide");
    }
})